...
| Hip (dancer/gymnast, extreme-ROM specific) | Femoroacetabular impingement (FAI — CAM/pincer morphology, posterosuperior labral tears) from repetitive supraphysiological hip motion (turnout, splits, extreme leg extensions) — a structural mechanism distinct from the generic soft-tissue causes in the row above | **Don't reflexively prescribe more hip mobility work here** — FAI is a bony/labral adaptation to cumulative extreme-ROM exposure, not a flexibility deficit, so chasing more turnout/range can add to the problem rather than fix it. Monitor cumulative extreme-ROM training volume the same disciplined way plyometric contacts and hyperextension-heavy skill work are capped, and strengthen in functional working ranges rather than end-range positions. Persistent hip pinching/catching at end-range gets referred out, not stretched through. |
...
- [Hip Pathology in the Dancing Athlete - A Clinical Review — AOAO, 2026](https://aoao.org/2026/05/13/hip-pathology-in-the-dancing-athlete-a-clinical-review/)
